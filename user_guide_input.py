...
print('welcome. Now that your data is loaded would type "add/change" or 1 to \
...
user_interface_input = input('what would you like to do: ')
while user_interface_input != 'start model' or str(4):
