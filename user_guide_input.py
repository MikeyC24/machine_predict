...
and you will be predicting a next value some time out.\
type "yes" if that is the case otherwise enter "no": """
...
we now need to decide if that data needs to be arranged.""")
	prediction_type = int(input("""but first what type of model would you like to run\
linear or classification. enter 1 for linear and 2 for classification: """))
...
the models. (you can save data before model""")
			...
			if user_interface_input == 1:
				user_interface_input_add = 0
				while user_interface_input_add != 9: 
