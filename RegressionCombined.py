...
class RegressionCombined:
	...
	def __init__(self, features, target, kfold_dict, X_train, X_test, y_train, y_test):
	...
	def regression_probs_model(self, **kwargs):
		...
		for x in instance_array:
			...
			dict_results_train_set[x] = results
		...
		return dict_results_simple, dict_results_kfold, dict_results_train_set

	def regression_probs_model_paramter_fit(self, **kwargs):
